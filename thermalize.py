...
ellipsoid_sim.run_NVT(n_steps=1e5, kT=2.0, tau_kt=5*ellipsoid_sim.dt)
ellipsoid_sim.run_NVT(n_steps=1e4, kT=2.0, tau_kt=5*ellipsoid_sim.dt)
target_box = get_target_box_number_density(density=.1*u.Unit("nm**-3"),n_beads=128)
ellipsoid_sim.run_update_volume(final_box_lengths=target_box, kT=2.0, n_steps=1e5,tau_kt=5*ellipsoid_sim.dt,
...
ellipsoid_gsd(gsd_file=gsd_path,new_file="thermalize-true.gsd",lpar=1.0,lperp=0.5, ellipsoid_types="R")
