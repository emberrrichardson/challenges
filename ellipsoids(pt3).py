...
system = Pack(molecules=ellipsoid_chain, density=.5*u.Unit("nm**-3"), 
...
target_box = get_target_box_number_density(density=.6*u.Unit("nm**-3"),n_beads=128)
ellipsoid_sim.run_update_volume(final_box_lengths=target_box, kT=1.0, n_steps=1e4,tau_kt=100*ellipsoid_sim.dt,period=10,
                                thermalize_particles=False)
