...
target_box = get_target_box_number_density(density=.41*u.Unit("nm**-3"),n_beads=128)
...
ellipsoid_gsd(gsd_file='/Users/ember/Projects/challenges/june17-11am.gsd',new_file="ovitoj17-11am.gsd",lpar=1.0,lperp=0.5,
              ellipsoid_types="R")
...
sim_data = np.genfromtxt("challenges/june17-11am.txt", names=True)
...
plt.savefig("Projects/June17-11am-PE.png")
...
plt.xlabel('Time')
plt.ylabel('PotentialEnergy')
plt.savefig("Projects/June17-11am-KE.png")
...
plt.xlabel('Time')
plt.ylabel('Volume')
plt.savefig("Projects/June17-11am-Vol.png")
...
plt.xlabel('Time')
plt.ylabel('Temp')
plt.savefig("Projects/June17-11am-Temp.png")
