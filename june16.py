...
ellipsoid_sim = Simulation(
    ...
    log_file_name='june16-230pm.txt')
...
ellipsoid_gsd(gsd_file='/Users/ember/Projects/challenges/june16-230pm.gsd',new_file="ovitoj16230.gsd",lpar=1.0,lperp=0.5, ellipsoid_types="R")


# In[49]:


sim_data = np.genfromtxt("challenges/june16-11am.txt", names=True)
